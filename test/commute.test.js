...
import {Commute} from '../src/methods';

describe('Testing class Commute', function () {
  ...
  it('Smart multiply method', function () {
    ...
    new Commute('multiply', impl, Num, Num);
    new Commute('multiply', function (obj) {
      return new Zero();
    }, Num, Zero);
    new Commute('multiply', function (obj) {
      return this.n !== 1 ? this : obj;
    }, Num, One);
