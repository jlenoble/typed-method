...
function method(name) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      strictReciprocal = _ref.strictReciprocal,
      looseReciprocal = _ref.looseReciprocal;
  ...
  return function (implementation, callerType) {
    ...
    if (calleeTypes.length > 1) {
      ...
      if (negate) {
        ...
        if ((equal || unequal || commutative || symmetric) && callerType !== calleeTypes[0]) {
      ...
      if (strict && condition) {
        ...
        if (strictReciprocal) {
          new _methods.Reciprocal(strictReciprocal, strict, callerType, calleeTypes[0]);
        }
      }
      ...
      if (loose && condition) {
        ...
        if (looseReciprocal) {
          new _methods.Reciprocal(looseReciprocal, loose, callerType, calleeTypes[0]);
        }
      }
    } else {
      if (negate) {
      ...
      if (strict && condition) {
        ...
        if (strictReciprocal) {
          new _methods.Reciprocal(strictReciprocal, strict, callerType, callerType);
        }
      }
      ...
      if (loose && condition) {
        ...
        if (looseReciprocal) {
          new _methods.Reciprocal(looseReciprocal, loose, callerType, callerType);
        }
      }
    }
  };
